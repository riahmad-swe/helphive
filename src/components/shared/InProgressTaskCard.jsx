export const InProgressTaskCard = ({
	...
	return (
		<div className="p-5 bg-neutral-50 shadow-md shadow-dark/10 rounded-lg">
			{/* Title */}
			<h6 className="text-lg font-semibold line-clamp-2 mb-4">{task.title}</h6>
			{/* Complete Button */}
			<button
				...
				onClick={() => {
					...
					setInProgressTasks(
						inProgressTasks.filter((ipTask) => ipTask.id !== task.id),
					);
